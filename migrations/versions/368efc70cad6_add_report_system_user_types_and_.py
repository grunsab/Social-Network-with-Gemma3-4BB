...
def upgrade():
    ...
    # NOTE: Explicit .create() calls for ENUMs removed.
    # Alembic/SQLAlchemy should handle creating these types if they don't exist
    # when they are used in create_table or add_column for PostgreSQL.
    # If they already exist (due to a previous partial migration), this avoids "DuplicateObject" errors
    # where checkfirst=True might not have behaved as expected.
